...
/// Specifies which semantic theme color the widget should use.
enum ThemeColorType {
  /// Primary color from the theme's color scheme.
  primary,

  /// Secondary color from the theme's color scheme.
  secondary,

  /// Error color from the theme's color scheme.
  error,

  /// A success color used to indicate positive state.
  success,

  /// A warning color used to indicate cautionary state.
  warning,

  /// Surface color from the theme's color scheme.
  surface,
}
            ...
            if (description != null) ...[
              ...
              Text(
                ...
                style: theme.textTheme.bodyMedium
                    .withColor(theme.colorScheme.onSurface.withValues(alpha: 0.7))
                    .height(1.4),
                textAlign: TextAlign.center,
              ),
            ],
